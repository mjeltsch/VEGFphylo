...
{'VEGF-C': ["NP_005420.1", None, 20000, ['VEGF-C', 'vascular endothelial growth factor C'], ['platelet-derived growth factor', 'PDGF and VEGF related factor', 'vascular endothelial growth factor A', 'vascular endothelial growth factor B', 'vascular endothelial growth factor D', 'placenta growth factor']],
 ...
 'PDGF-A': ["", None, 20000, ['PDGF-A', 'platelet-derived growth factor A'], ['platelet-derived growth factor B', 'platelet-derived growth factor C', 'platelet-derived growth factor D', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']],
 'PDGF-B': ["", None, 20000, ['PDGF-B', 'platelet-derived growth factor B'], ['platelet-derived growth factor A', 'platelet-derived growth factor C', 'platelet-derived growth factor D', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']],
 'PDGF-C': ["", None, 20000, ['PDGF-C', 'platelet-derived growth factor C'], ['platelet-derived growth factor A', 'platelet-derived growth factor B', 'platelet-derived growth factor D', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']],
 'PDGF-D': ["", None, 20000, ['PDGF-D', 'platelet-derived growth factor D'], ['platelet-derived growth factor A', 'platelet-derived growth factor B', 'platelet-derived growth factor C', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']]]}
