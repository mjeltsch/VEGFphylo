...
#
# 0 protein_id [fasta]
# 1 subrange (e.g. "50-200"; only used to exclude the PDGF-C/D CUB domain at the moment to prevent too many unrelated blast hists)
...
# 'PDGF-C': ["NP_057289.1", "164-345", 20000, ['PDGF-C', 'platelet-derived growth factor C'], ['platelet-derived growth factor A', 'platelet-derived growth factor B', 'platelet-derived growth factor D', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']],
 'PDGF-D': ["NP_079484.1", "171-370", 20000, ['PDGF-D', 'platelet-derived growth factor D'], ['platelet-derived growth factor A', 'platelet-derived growth factor B', 'platelet-derived growth factor C', 'PDGF and VEGF related factor', 'vascular endothelial growth factor', 'placenta growth factor']]}
